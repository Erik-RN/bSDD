...
/// </summary>
[DataContract]
public partial class ClassPropertyContractV1 :  IEquatable<ClassPropertyContractV1>, IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ClassPropertyContractV1" /> class.
    /// </summary>
    ...
    /// <param name="definition">Definition of the property.  Description is same as definition if at Property level no description has been given..</param>
    ...
    public ClassPropertyContractV1(string name = default(string), string uri = default(string), string description = default(string), string definition = default(string), string dataType = default(string), string dimension = default(string), int? dimensionLength = default(int?), int? dimensionMass = default(int?), int? dimensionTime = default(int?), int? dimensionElectricCurrent = default(int?), int? dimensionThermodynamicTemperature = default(int?), int? dimensionAmountOfSubstance = default(int?), int? dimensionLuminousIntensity = default(int?), List<string> dynamicParameterPropertyCodes = default(List<string>), string example = default(string), bool? isDynamic = default(bool?), bool? isRequired = default(bool?), bool? isWritable = default(bool?), double? maxExclusive = default(double?), double? maxInclusive = default(double?), double? minExclusive = default(double?), double? minInclusive = default(double?), string pattern = default(string), string physicalQuantity = default(string), List<ClassPropertyValueContractV1> allowedValues = default(List<ClassPropertyValueContractV1>), string predefinedValue = default(string), string propertyCode = default(string), string propertyDictionaryName = default(string), string propertyDictionaryUri = default(string), string propertyUri = default(string), string propertySet = default(string), string propertyStatus = default(string), string propertyValueKind = default(string), string symbol = default(string), List<string> units = default(List<string>), List<string> qudtCodes = default(List<string>))
    {
        // to ensure "name" is required (not null)
        if (name == null)
        {
            throw new InvalidDataException("name is a required property for ClassPropertyContractV1 and cannot be null");
        }
        else
        {
            this.Name = name;
    ...
    /// <summary>
    /// Definition of the property.  Description is same as definition if at Property level no description has been given.
    /// </summary>
    /// <value>Definition of the property.  Description is same as definition if at Property level no description has been given.</value>
    ...
    public List<ClassPropertyValueContractV1> AllowedValues { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ClassPropertyContractV1 {\n");
    ...
    {
        return this.Equals(input as ClassPropertyContractV1);
    }

    /// <summary>
    /// Returns true if ClassPropertyContractV1 instances are equal
    /// </summary>
    /// <param name="input">Instance of ClassPropertyContractV1 to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ClassPropertyContractV1 input)
    {
        if (input == null)
            return false;
