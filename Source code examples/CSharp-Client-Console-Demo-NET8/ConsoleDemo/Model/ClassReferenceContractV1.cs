...
/// </summary>
[DataContract]
public partial class ClassReferenceContractV1 :  IEquatable<ClassReferenceContractV1>, IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ClassReferenceContractV1" /> class.
    /// </summary>
    ...
    {
        return this.Equals(input as ClassReferenceContractV1);
    }

    /// <summary>
    /// Returns true if ClassReferenceContractV1 instances are equal
    /// </summary>
    /// <param name="input">Instance of ClassReferenceContractV1 to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ClassReferenceContractV1 input)
    {
        if (input == null)
            return false;
