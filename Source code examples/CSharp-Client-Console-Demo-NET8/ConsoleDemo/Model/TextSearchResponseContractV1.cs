...
/// </summary>
[DataContract]
public partial class TextSearchResponseContractV1 :  IEquatable<TextSearchResponseContractV1>, IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="TextSearchResponseContractV1" /> class.
    /// </summary>
    ...
    public TextSearchResponseContractV1(int? totalCount = default(int?), int? offset = default(int?), int? count = default(int?), List<TextSearchResponseClassContractV1> classes = default(List<TextSearchResponseClassContractV1>), List<TextSearchResponseDictionaryContractV1> dictionaries = default(List<TextSearchResponseDictionaryContractV1>), List<TextSearchResponsePropertyContractV1> properties = default(List<TextSearchResponsePropertyContractV1>))
    {
    ...
    public List<TextSearchResponseClassContractV1> Classes { get; set; }
    ...
    public List<TextSearchResponseDictionaryContractV1> Dictionaries { get; set; }
    ...
    public List<TextSearchResponsePropertyContractV1> Properties { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class TextSearchResponseContractV1 {\n");
    ...
    {
        return this.Equals(input as TextSearchResponseContractV1);
    }

    /// <summary>
    /// Returns true if TextSearchResponseContractV1 instances are equal
    /// </summary>
    /// <param name="input">Instance of TextSearchResponseContractV1 to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(TextSearchResponseContractV1 input)
    {
        if (input == null)
            return false;
