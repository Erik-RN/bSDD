...
/// <summary>
/// ClassRelationItemContractV1
/// </summary>
[DataContract]
public partial class ClassRelationItemContractV1 :  IEquatable<ClassRelationItemContractV1>, IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ClassRelationItemContractV1" /> class.
    /// </summary>
    /// <param name="relationType">Can be one of: HasReference, IsEqualTo, IsSynonymOf, IsParentOf, IsChildOf, HasPart (required).</param>
    /// <param name="classUri">URI of the related class (required).</param>
    /// <param name="className">Name of the related class.</param>
    ...
    public ClassRelationItemContractV1(string relationType = default(string), string classUri = default(string), string className = default(string), double? fraction = default(double?), string dictionaryUri = default(string))
    {
        // to ensure "relationType" is required (not null)
        if (relationType == null)
        {
            throw new InvalidDataException("relationType is a required property for ClassRelationItemContractV1 and cannot be null");
        }
        else
        {
        ...
        if (classUri == null)
        {
            throw new InvalidDataException("classUri is a required property for ClassRelationItemContractV1 and cannot be null");
        }
        else
        {
    ...
    /// </summary>
    /// <value>URI of the related class</value>
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ClassRelationItemContractV1 {\n");
    ...
    {
        return this.Equals(input as ClassRelationItemContractV1);
    }

    /// <summary>
    /// Returns true if ClassRelationItemContractV1 instances are equal
    /// </summary>
    /// <param name="input">Instance of ClassRelationItemContractV1 to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ClassRelationItemContractV1 input)
    {
        if (input == null)
            return false;
