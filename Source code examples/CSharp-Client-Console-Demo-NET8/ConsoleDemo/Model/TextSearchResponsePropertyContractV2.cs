...
/// <summary>
/// TextSearchResponsePropertyContractV2
/// </summary>
[DataContract]
public partial class TextSearchResponsePropertyContractV2 :  IEquatable<TextSearchResponsePropertyContractV2>, IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="TextSearchResponsePropertyContractV2" /> class.
    /// </summary>
    ...
    public TextSearchResponsePropertyContractV2(string dictionaryUri = default(string), string uri = default(string), string code = default(string), string name = default(string), string description = default(string))
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class TextSearchResponsePropertyContractV2 {\n");
    ...
    {
        return this.Equals(input as TextSearchResponsePropertyContractV2);
    }

    /// <summary>
    /// Returns true if TextSearchResponsePropertyContractV2 instances are equal
    /// </summary>
    /// <param name="input">Instance of TextSearchResponsePropertyContractV2 to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(TextSearchResponsePropertyContractV2 input)
    {
        if (input == null)
            return false;
