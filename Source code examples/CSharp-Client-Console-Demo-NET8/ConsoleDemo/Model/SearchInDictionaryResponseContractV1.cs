...
/// </summary>
[DataContract]
public partial class SearchInDictionaryResponseContractV1 :  IEquatable<SearchInDictionaryResponseContractV1>, IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SearchInDictionaryResponseContractV1" /> class.
    /// </summary>
    /// <param name="totalCount">totalCount.</param>
    /// <param name="offset">offset.</param>
    /// <param name="count">count.</param>
    /// <param name="dictionary">dictionary.</param>
    public SearchInDictionaryResponseContractV1(int? totalCount = default(int?), int? offset = default(int?), int? count = default(int?), DictionarySearchResultContractV1 dictionary = default(DictionarySearchResultContractV1))
    {
    ...
    public DictionarySearchResultContractV1 Dictionary { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class SearchInDictionaryResponseContractV1 {\n");
    ...
    {
        return this.Equals(input as SearchInDictionaryResponseContractV1);
    }

    /// <summary>
    /// Returns true if SearchInDictionaryResponseContractV1 instances are equal
    /// </summary>
    /// <param name="input">Instance of SearchInDictionaryResponseContractV1 to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(SearchInDictionaryResponseContractV1 input)
    {
        if (input == null)
            return false;
