...
/// </summary>
[DataContract]
public partial class ClassPropertyValueContractV1 :  IEquatable<ClassPropertyValueContractV1>, IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ClassPropertyValueContractV1" /> class.
    /// </summary>
    ...
    public ClassPropertyValueContractV1(string uri = default(string), string code = default(string), string value = default(string), string description = default(string), int? sortNumber = default(int?))
    {
        // to ensure "value" is required (not null)
        if (value == null)
        {
            throw new InvalidDataException("value is a required property for ClassPropertyValueContractV1 and cannot be null");
        }
        else
        {
            this.Value = value;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ClassPropertyValueContractV1 {\n");
    ...
    {
        return this.Equals(input as ClassPropertyValueContractV1);
    }

    /// <summary>
    /// Returns true if ClassPropertyValueContractV1 instances are equal
    /// </summary>
    /// <param name="input">Instance of ClassPropertyValueContractV1 to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ClassPropertyValueContractV1 input)
    {
        if (input == null)
            return false;
