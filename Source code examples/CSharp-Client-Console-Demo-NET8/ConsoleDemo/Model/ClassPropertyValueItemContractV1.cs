...
/// </summary>
[DataContract]
public partial class ClassPropertyValueItemContractV1 :  IEquatable<ClassPropertyValueItemContractV1>, IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ClassPropertyValueItemContractV1" /> class.
    /// </summary>
    ...
    public ClassPropertyValueItemContractV1(string uri = default(string), string code = default(string), string value = default(string), string description = default(string), int? sortNumber = default(int?))
    {
        // to ensure "value" is required (not null)
        if (value == null)
        {
            throw new InvalidDataException("value is a required property for ClassPropertyValueItemContractV1 and cannot be null");
        }
        else
        {
            this.Value = value;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ClassPropertyValueItemContractV1 {\n");
    ...
    {
        return this.Equals(input as ClassPropertyValueItemContractV1);
    }

    /// <summary>
    /// Returns true if ClassPropertyValueItemContractV1 instances are equal
    /// </summary>
    /// <param name="input">Instance of ClassPropertyValueItemContractV1 to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ClassPropertyValueItemContractV1 input)
    {
        if (input == null)
            return false;
