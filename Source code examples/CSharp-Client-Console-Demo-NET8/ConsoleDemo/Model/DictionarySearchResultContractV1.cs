...
/// <summary>
/// DictionarySearchResultContractV1
/// </summary>
[DataContract]
public partial class DictionarySearchResultContractV1 :  IEquatable<DictionarySearchResultContractV1>, IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="DictionarySearchResultContractV1" /> class.
    /// </summary>
    /// <param name="name">name.</param>
    /// <param name="uri">uri.</param>
    /// <param name="classes">classes.</param>
    public DictionarySearchResultContractV1(string name = default(string), string uri = default(string), List<ClassSearchResultContractV1> classes = default(List<ClassSearchResultContractV1>))
    {
        this.Name = name;
        this.Uri = uri;
    ...
    public List<ClassSearchResultContractV1> Classes { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class DictionarySearchResultContractV1 {\n");
    ...
    {
        return this.Equals(input as DictionarySearchResultContractV1);
    }

    /// <summary>
    /// Returns true if DictionarySearchResultContractV1 instances are equal
    /// </summary>
    /// <param name="input">Instance of DictionarySearchResultContractV1 to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(DictionarySearchResultContractV1 input)
    {
        if (input == null)
            return false;
