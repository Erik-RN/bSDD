...
/// <summary>
/// MaterialClassificationRelationContractV1
/// </summary>
[DataContract]
public partial class MaterialClassificationRelationContractV1 :  IEquatable<MaterialClassificationRelationContractV1>, IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="MaterialClassificationRelationContractV1" /> class.
    /// </summary>
    /// <param name="name">name.</param>
    /// <param name="namespaceUri">namespaceUri.</param>
    public MaterialClassificationRelationContractV1(string name = default(string), string namespaceUri = default(string))
    {
        this.Name = name;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class MaterialClassificationRelationContractV1 {\n");
    ...
    {
        return this.Equals(input as MaterialClassificationRelationContractV1);
    }

    /// <summary>
    /// Returns true if MaterialClassificationRelationContractV1 instances are equal
    /// </summary>
    /// <param name="input">Instance of MaterialClassificationRelationContractV1 to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(MaterialClassificationRelationContractV1 input)
    {
        if (input == null)
            return false;
