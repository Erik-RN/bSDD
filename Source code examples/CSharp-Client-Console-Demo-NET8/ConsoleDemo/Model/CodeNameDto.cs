...
/// </summary>
[DataContract]
public partial class CodeNameDto :  IEquatable<CodeNameDto>, IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CodeNameDto" /> class.
    /// </summary>
    /// <param name="code">code.</param>
    /// <param name="name">name.</param>
    public CodeNameDto(string code = default(string), string name = default(string))
    {
        this.Code = code;
        this.Name = name;
    }
    ...
    {
        return this.Equals(input as CodeNameDto);
    }

    /// <summary>
    /// Returns true if CodeNameDto instances are equal
    /// </summary>
    /// <param name="input">Instance of CodeNameDto to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(CodeNameDto input)
    {
        if (input == null)
            return false;
