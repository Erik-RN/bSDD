...
/// <summary>
/// TextSearchResponseClassContractV2
/// </summary>
[DataContract]
public partial class TextSearchResponseClassContractV2 :  IEquatable<TextSearchResponseClassContractV2>, IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="TextSearchResponseClassContractV2" /> class.
    /// </summary>
    ...
    public TextSearchResponseClassContractV2(string dictionaryUri = default(string), string name = default(string), string code = default(string), string referenceCode = default(string), string uri = default(string), string classType = default(string), string description = default(string), string parentClassName = default(string), List<string> relatedIfcEntityNames = default(List<string>))
    {
    ...
    public override string ToString()
    {
        ...
        sb.Append("class TextSearchResponseClassContractV2 {\n");
    ...
    {
        return this.Equals(input as TextSearchResponseClassContractV2);
    }

    /// <summary>
    /// Returns true if TextSearchResponseClassContractV2 instances are equal
    /// </summary>
    /// <param name="input">Instance of TextSearchResponseClassContractV2 to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(TextSearchResponseClassContractV2 input)
    {
        if (input == null)
            return false;
