...
/// </summary>
[DataContract]
public partial class MaterialContractV1 :  IEquatable<MaterialContractV1>, IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="MaterialContractV1" /> class.
    /// </summary>
    /// <param name="domainNamespaceUri">Namespace URI of the domain.</param>
    ...
    /// <param name="synonyms">List of synonyms for the material.</param>
    /// <param name="parentMaterialReference">parentMaterialReference.</param>
    /// <param name="materialProperties">List of the properties of this material.</param>
    /// <param name="classificationRelations">List of relations to classifications, can be reference to materials of other domains.</param>
    /// <param name="childMaterialReferences">List of child materials (only filled if requested).</param>
    public MaterialContractV1(string domainNamespaceUri = default(string), DateTime? activationDateUtc = default(DateTime?), string code = default(string), string creatorLanguageCode = default(string), List<string> countriesOfUse = default(List<string>), string countryOfOrigin = default(string), DateTime? deActivationDateUtc = default(DateTime?), string definition = default(string), string deprecationExplanation = default(string), string documentReference = default(string), string name = default(string), string namespaceUri = default(string), List<string> replacedObjectCodes = default(List<string>), List<string> replacingObjectCodes = default(List<string>), DateTime? revisionDateUtc = default(DateTime?), int? revisionNumber = default(int?), string status = default(string), List<string> subdivisionsOfUse = default(List<string>), string uid = default(string), DateTime? versionDateUtc = default(DateTime?), int? versionNumber = default(int?), string visualRepresentationUri = default(string), List<string> synonyms = default(List<string>), MaterialReferenceContractV1 parentMaterialReference = default(MaterialReferenceContractV1), List<MaterialPropertyContractV1> materialProperties = default(List<MaterialPropertyContractV1>), List<MaterialRelationContractV1> classificationRelations = default(List<MaterialRelationContractV1>), List<MaterialReferenceContractV1> childMaterialReferences = default(List<MaterialReferenceContractV1>))
    {
        // to ensure "activationDateUtc" is required (not null)
        if (activationDateUtc == null)
        {
            throw new InvalidDataException("activationDateUtc is a required property for MaterialContractV1 and cannot be null");
        }
        else
        {
        ...
        {
            throw new InvalidDataException("code is a required property for MaterialContractV1 and cannot be null");
        }
        else
        {
            this.Code = code;
        ...
        if (name == null)
        {
            throw new InvalidDataException("name is a required property for MaterialContractV1 and cannot be null");
        }
        else
        {
            this.Name = name;
        ...
        {
            throw new InvalidDataException("namespaceUri is a required property for MaterialContractV1 and cannot be null");
        }
        else
        {
        ...
        if (status == null)
        {
            throw new InvalidDataException("status is a required property for MaterialContractV1 and cannot be null");
        }
        else
        {
            this.Status = status;
        ...
        {
            throw new InvalidDataException("versionDateUtc is a required property for MaterialContractV1 and cannot be null");
        }
        else
        {
        ...
        this.ParentMaterialReference = parentMaterialReference;
        this.MaterialProperties = materialProperties;
        this.ClassificationRelations = classificationRelations;
        this.ChildMaterialReferences = childMaterialReferences;
    }
        
    /// <summary>
    /// Namespace URI of the domain
    /// </summary>
    /// <value>Namespace URI of the domain</value>
    ...
    /// </summary>
    /// <value>List of synonyms for the material</value>
    [DataMember(Name="synonyms", EmitDefaultValue=false)]
    public List<string> Synonyms { get; set; }

    /// <summary>
    /// Gets or Sets ParentMaterialReference
    /// </summary>
    [DataMember(Name="parentMaterialReference", EmitDefaultValue=false)]
    public MaterialReferenceContractV1 ParentMaterialReference { get; set; }

    /// <summary>
    /// List of the properties of this material
    /// </summary>
    /// <value>List of the properties of this material</value>
    [DataMember(Name="materialProperties", EmitDefaultValue=false)]
    public List<MaterialPropertyContractV1> MaterialProperties { get; set; }

    /// <summary>
    /// List of relations to classifications, can be reference to materials of other domains
    /// </summary>
    /// <value>List of relations to classifications, can be reference to materials of other domains</value>
    [DataMember(Name="classificationRelations", EmitDefaultValue=false)]
    public List<MaterialRelationContractV1> ClassificationRelations { get; set; }

    /// <summary>
    /// List of child materials (only filled if requested)
    /// </summary>
    /// <value>List of child materials (only filled if requested)</value>
    [DataMember(Name="childMaterialReferences", EmitDefaultValue=false)]
    public List<MaterialReferenceContractV1> ChildMaterialReferences { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class MaterialContractV1 {\n");
        ...
        sb.Append("  ParentMaterialReference: ").Append(ParentMaterialReference).Append("\n");
        sb.Append("  MaterialProperties: ").Append(MaterialProperties).Append("\n");
        sb.Append("  ClassificationRelations: ").Append(ClassificationRelations).Append("\n");
        sb.Append("  ChildMaterialReferences: ").Append(ChildMaterialReferences).Append("\n");
        sb.Append("}\n");
        return sb.ToString();
    }
    ...
    {
        return this.Equals(input as MaterialContractV1);
    }

    /// <summary>
    /// Returns true if MaterialContractV1 instances are equal
    /// </summary>
    /// <param name="input">Instance of MaterialContractV1 to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(MaterialContractV1 input)
    {
        if (input == null)
            return false;
        ...
        return 
            ...
            (
                this.ParentMaterialReference == input.ParentMaterialReference ||
                (this.ParentMaterialReference != null &&
                 this.ParentMaterialReference.Equals(input.ParentMaterialReference))
            ) && 
            (
                this.MaterialProperties == input.MaterialProperties ||
                this.MaterialProperties != null &&
                input.MaterialProperties != null &&
                this.MaterialProperties.SequenceEqual(input.MaterialProperties)
            ) && 
            (
            ...
            (
                this.ChildMaterialReferences == input.ChildMaterialReferences ||
                this.ChildMaterialReferences != null &&
                input.ChildMaterialReferences != null &&
                this.ChildMaterialReferences.SequenceEqual(input.ChildMaterialReferences)
            );
    }
    ...
    public override int GetHashCode()
    {
        unchecked // Overflow is fine, just wrap
        {
            ...
            if (this.ParentMaterialReference != null)
                hashCode = hashCode * 59 + this.ParentMaterialReference.GetHashCode();
            if (this.MaterialProperties != null)
                hashCode = hashCode * 59 + this.MaterialProperties.GetHashCode();
            if (this.ClassificationRelations != null)
                hashCode = hashCode * 59 + this.ClassificationRelations.GetHashCode();
            if (this.ChildMaterialReferences != null)
                hashCode = hashCode * 59 + this.ChildMaterialReferences.GetHashCode();
            return hashCode;
        }
    }
