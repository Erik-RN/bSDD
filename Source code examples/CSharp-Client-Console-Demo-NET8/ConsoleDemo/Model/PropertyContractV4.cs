...
/// </summary>
[DataContract]
public partial class PropertyContractV4 :  IEquatable<PropertyContractV4>, IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="PropertyContractV4" /> class.
    /// </summary>
    ...
    /// <param name="qudtCodes">List of QUDT unit codes (if QUDT code available).</param>
    /// <param name="propertyClasses">List of the classes this property is used in (only classes of same dictionary as the property are listed).</param>
    public PropertyContractV4(string dictionaryUri = default(string), DateTime? activationDateUtc = default(DateTime?), string code = default(string), string creatorLanguageCode = default(string), List<string> countriesOfUse = default(List<string>), string countryOfOrigin = default(string), DateTime? deActivationDateUtc = default(DateTime?), string definition = default(string), string deprecationExplanation = default(string), string description = default(string), string documentReference = default(string), string name = default(string), string uri = default(string), List<string> replacedObjectCodes = default(List<string>), List<string> replacingObjectCodes = default(List<string>), DateTime? revisionDateUtc = default(DateTime?), int? revisionNumber = default(int?), string status = default(string), List<string> subdivisionsOfUse = default(List<string>), string uid = default(string), DateTime? versionDateUtc = default(DateTime?), int? versionNumber = default(int?), string visualRepresentationUri = default(string), List<string> connectedPropertyCodes = default(List<string>), string dataType = default(string), string dimension = default(string), int? dimensionLength = default(int?), int? dimensionMass = default(int?), int? dimensionTime = default(int?), int? dimensionElectricCurrent = default(int?), int? dimensionThermodynamicTemperature = default(int?), int? dimensionAmountOfSubstance = default(int?), int? dimensionLuminousIntensity = default(int?), List<string> dynamicParameterPropertyCodes = default(List<string>), string example = default(string), bool? isDynamic = default(bool?), double? maxExclusive = default(double?), double? maxInclusive = default(double?), string methodOfMeasurement = default(string), double? minExclusive = default(double?), double? minInclusive = default(double?), string pattern = default(string), string physicalQuantity = default(string), List<PropertyValueContractV4> allowedValues = default(List<PropertyValueContractV4>), string propertyValueKind = default(string), List<PropertyRelationContractV4> propertyRelations = default(List<PropertyRelationContractV4>), string textFormat = default(string), List<string> units = default(List<string>), List<string> qudtCodes = default(List<string>), List<PropertyClassContractV4> propertyClasses = default(List<PropertyClassContractV4>))
    {
        // to ensure "activationDateUtc" is required (not null)
        if (activationDateUtc == null)
        {
            throw new InvalidDataException("activationDateUtc is a required property for PropertyContractV4 and cannot be null");
        }
        else
        {
        ...
        {
            throw new InvalidDataException("code is a required property for PropertyContractV4 and cannot be null");
        }
        else
        {
            this.Code = code;
        ...
        if (name == null)
        {
            throw new InvalidDataException("name is a required property for PropertyContractV4 and cannot be null");
        }
        else
        {
            this.Name = name;
        ...
        if (uri == null)
        {
            throw new InvalidDataException("uri is a required property for PropertyContractV4 and cannot be null");
        }
        else
        {
            this.Uri = uri;
        ...
        if (status == null)
        {
            throw new InvalidDataException("status is a required property for PropertyContractV4 and cannot be null");
        }
        else
        {
            this.Status = status;
        ...
        {
            throw new InvalidDataException("versionDateUtc is a required property for PropertyContractV4 and cannot be null");
        }
        else
        {
    ...
    public List<PropertyValueContractV4> AllowedValues { get; set; }
    ...
    public List<PropertyRelationContractV4> PropertyRelations { get; set; }
    ...
    /// </summary>
    /// <value>List of QUDT unit codes (if QUDT code available)</value>
    ...
    /// </summary>
    /// <value>List of the classes this property is used in (only classes of same dictionary as the property are listed)</value>
    [DataMember(Name="propertyClasses", EmitDefaultValue=false)]
    public List<PropertyClassContractV4> PropertyClasses { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class PropertyContractV4 {\n");
    ...
    {
        return this.Equals(input as PropertyContractV4);
    }

    /// <summary>
    /// Returns true if PropertyContractV4 instances are equal
    /// </summary>
    /// <param name="input">Instance of PropertyContractV4 to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(PropertyContractV4 input)
    {
        if (input == null)
            return false;
