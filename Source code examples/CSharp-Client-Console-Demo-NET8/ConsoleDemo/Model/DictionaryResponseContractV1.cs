...
/// </summary>
[DataContract]
public partial class DictionaryResponseContractV1 :  IEquatable<DictionaryResponseContractV1>, IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="DictionaryResponseContractV1" /> class.
    /// </summary>
    /// <param name="totalCount">totalCount.</param>
    /// <param name="offset">offset.</param>
    /// <param name="count">count.</param>
    /// <param name="dictionaries">dictionaries.</param>
    public DictionaryResponseContractV1(int? totalCount = default(int?), int? offset = default(int?), int? count = default(int?), List<DictionaryContractV1> dictionaries = default(List<DictionaryContractV1>))
    {
    ...
    public List<DictionaryContractV1> Dictionaries { get; set; }
    ...
    {
        return this.Equals(input as DictionaryResponseContractV1);
    }

    /// <summary>
    /// Returns true if DictionaryResponseContractV1 instances are equal
    /// </summary>
    /// <param name="input">Instance of DictionaryResponseContractV1 to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(DictionaryResponseContractV1 input)
    {
        if (input == null)
            return false;
