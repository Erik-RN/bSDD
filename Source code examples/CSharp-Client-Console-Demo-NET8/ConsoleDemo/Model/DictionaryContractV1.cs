...
/// </summary>
[DataContract]
public partial class DictionaryContractV1 :  IEquatable<DictionaryContractV1>, IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="DictionaryContractV1" /> class.
    /// </summary>
    ...
    /// <param name="availableLanguages">List of (partly) available languages for this dictionary.</param>
    public DictionaryContractV1(string code = default(string), string uri = default(string), string name = default(string), string version = default(string), string organizationCodeOwner = default(string), string organizationNameOwner = default(string), string changeRequestEmail = default(string), string defaultLanguageCode = default(string), bool? isLatestVersion = default(bool?), bool? isVerified = default(bool?), string license = default(string), string licenseUrl = default(string), string qualityAssuranceProcedure = default(string), string qualityAssuranceProcedureUrl = default(string), string status = default(string), string moreInfoUrl = default(string), DateTime? releaseDate = default(DateTime?), DateTime? lastUpdatedUtc = default(DateTime?), List<CodeNameDto> availableLanguages = default(List<CodeNameDto>))
    {
        ...
        if (name == null)
        {
            throw new InvalidDataException("name is a required property for DictionaryContractV1 and cannot be null");
        }
        else
        {
            this.Name = name;
        ...
        {
            throw new InvalidDataException("organizationCodeOwner is a required property for DictionaryContractV1 and cannot be null");
        }
        else
        {
        ...
        {
            throw new InvalidDataException("organizationNameOwner is a required property for DictionaryContractV1 and cannot be null");
        }
        else
        {
        ...
        {
            throw new InvalidDataException("defaultLanguageCode is a required property for DictionaryContractV1 and cannot be null");
        }
        else
        {
        ...
        {
            throw new InvalidDataException("isLatestVersion is a required property for DictionaryContractV1 and cannot be null");
        }
        else
        {
        ...
        if (isVerified == null)
        {
            throw new InvalidDataException("isVerified is a required property for DictionaryContractV1 and cannot be null");
        }
        else
        {
    ...
    /// </summary>
    /// <value>List of (partly) available languages for this dictionary</value>
    [DataMember(Name="availableLanguages", EmitDefaultValue=false)]
    public List<CodeNameDto> AvailableLanguages { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class DictionaryContractV1 {\n");
    ...
    {
        return this.Equals(input as DictionaryContractV1);
    }

    /// <summary>
    /// Returns true if DictionaryContractV1 instances are equal
    /// </summary>
    /// <param name="input">Instance of DictionaryContractV1 to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(DictionaryContractV1 input)
    {
        if (input == null)
            return false;
