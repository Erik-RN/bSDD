...
/// </summary>
[DataContract]
public partial class PropertyContractV3 :  IEquatable<PropertyContractV3>, IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="PropertyContractV3" /> class.
    /// </summary>
    ...
    public PropertyContractV3(string domainNamespaceUri = default(string), DateTime? activationDateUtc = default(DateTime?), string code = default(string), string creatorLanguageCode = default(string), List<string> countriesOfUse = default(List<string>), string countryOfOrigin = default(string), DateTime? deActivationDateUtc = default(DateTime?), string definition = default(string), string deprecationExplanation = default(string), string documentReference = default(string), string name = default(string), string namespaceUri = default(string), List<string> replacedObjectCodes = default(List<string>), List<string> replacingObjectCodes = default(List<string>), DateTime? revisionDateUtc = default(DateTime?), int? revisionNumber = default(int?), string status = default(string), List<string> subdivisionsOfUse = default(List<string>), string uid = default(string), DateTime? versionDateUtc = default(DateTime?), int? versionNumber = default(int?), string visualRepresentationUri = default(string), string description = default(string), List<string> connectedPropertyCodes = default(List<string>), string dataType = default(string), string dimension = default(string), int? dimensionLength = default(int?), int? dimensionMass = default(int?), int? dimensionTime = default(int?), int? dimensionElectricCurrent = default(int?), int? dimensionThermodynamicTemperature = default(int?), int? dimensionAmountOfSubstance = default(int?), int? dimensionLuminousIntensity = default(int?), List<string> dynamicParameterPropertyCodes = default(List<string>), string example = default(string), bool? isDynamic = default(bool?), double? maxExclusive = default(double?), double? maxInclusive = default(double?), string methodOfMeasurement = default(string), double? minExclusive = default(double?), double? minInclusive = default(double?), string pattern = default(string), string physicalQuantity = default(string), List<PropertyValueContractV3> allowedValues = default(List<PropertyValueContractV3>), string propertyValueKind = default(string), List<PropertyRelationContractV3> propertyRelations = default(List<PropertyRelationContractV3>), string textFormat = default(string), List<string> units = default(List<string>), List<string> qudtCodes = default(List<string>))
    {
        // to ensure "activationDateUtc" is required (not null)
        if (activationDateUtc == null)
        {
            throw new InvalidDataException("activationDateUtc is a required property for PropertyContractV3 and cannot be null");
        }
        else
        {
        ...
        if (name == null)
        {
            throw new InvalidDataException("name is a required property for PropertyContractV3 and cannot be null");
        }
        else
        {
            this.Name = name;
        ...
        {
            throw new InvalidDataException("namespaceUri is a required property for PropertyContractV3 and cannot be null");
        }
        else
        {
        ...
        if (status == null)
        {
            throw new InvalidDataException("status is a required property for PropertyContractV3 and cannot be null");
        }
        else
        {
            this.Status = status;
        ...
        {
            throw new InvalidDataException("versionDateUtc is a required property for PropertyContractV3 and cannot be null");
        }
        else
        {
    ...
    public List<PropertyValueContractV3> AllowedValues { get; set; }
    ...
    public List<PropertyRelationContractV3> PropertyRelations { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class PropertyContractV3 {\n");
    ...
    {
        return this.Equals(input as PropertyContractV3);
    }

    /// <summary>
    /// Returns true if PropertyContractV3 instances are equal
    /// </summary>
    /// <param name="input">Instance of PropertyContractV3 to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(PropertyContractV3 input)
    {
        if (input == null)
            return false;
