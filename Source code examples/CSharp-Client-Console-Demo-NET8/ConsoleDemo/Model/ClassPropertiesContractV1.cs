...
/// </summary>
[DataContract]
public partial class ClassPropertiesContractV1 :  IEquatable<ClassPropertiesContractV1>, IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ClassPropertiesContractV1" /> class.
    /// </summary>
    ...
    public ClassPropertiesContractV1(int? totalCount = default(int?), int? offset = default(int?), int? count = default(int?), string classUri = default(string), List<ClassPropertyItemContractV1> classProperties = default(List<ClassPropertyItemContractV1>))
    {
    ...
    public List<ClassPropertyItemContractV1> ClassProperties { get; set; }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class ClassPropertiesContractV1 {\n");
    ...
    {
        return this.Equals(input as ClassPropertiesContractV1);
    }

    /// <summary>
    /// Returns true if ClassPropertiesContractV1 instances are equal
    /// </summary>
    /// <param name="input">Instance of ClassPropertiesContractV1 to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ClassPropertiesContractV1 input)
    {
        if (input == null)
            return false;
