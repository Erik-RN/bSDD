...
/// </summary>
[DataContract]
public partial class PropertyListItemContractV1 :  IEquatable<PropertyListItemContractV1>, IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="PropertyListItemContractV1" /> class.
    /// </summary>
    /// <param name="uri">uri.</param>
    /// <param name="code">code.</param>
    /// <param name="name">name.</param>
    /// <param name="descriptionPart">Description of the class, max 101 characters long.</param>
    public PropertyListItemContractV1(string uri = default(string), string code = default(string), string name = default(string), string descriptionPart = default(string))
    {
        this.Uri = uri;
        this.Code = code;
        this.Name = name;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class PropertyListItemContractV1 {\n");
    ...
    {
        return this.Equals(input as PropertyListItemContractV1);
    }

    /// <summary>
    /// Returns true if PropertyListItemContractV1 instances are equal
    /// </summary>
    /// <param name="input">Instance of PropertyListItemContractV1 to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(PropertyListItemContractV1 input)
    {
        if (input == null)
            return false;
