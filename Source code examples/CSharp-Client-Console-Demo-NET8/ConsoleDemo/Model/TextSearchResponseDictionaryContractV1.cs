...
/// <summary>
/// TextSearchResponseDictionaryContractV1
/// </summary>
[DataContract]
public partial class TextSearchResponseDictionaryContractV1 :  IEquatable<TextSearchResponseDictionaryContractV1>, IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="TextSearchResponseDictionaryContractV1" /> class.
    /// </summary>
    /// <param name="uri">uri.</param>
    /// <param name="name">name.</param>
    public TextSearchResponseDictionaryContractV1(string uri = default(string), string name = default(string))
    {
        this.Uri = uri;
        this.Name = name;
    }
    ...
    public override string ToString()
    {
        ...
        sb.Append("class TextSearchResponseDictionaryContractV1 {\n");
    ...
    {
        return this.Equals(input as TextSearchResponseDictionaryContractV1);
    }

    /// <summary>
    /// Returns true if TextSearchResponseDictionaryContractV1 instances are equal
    /// </summary>
    /// <param name="input">Instance of TextSearchResponseDictionaryContractV1 to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(TextSearchResponseDictionaryContractV1 input)
    {
        if (input == null)
            return false;
